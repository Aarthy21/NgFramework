...
@Component({
  selector: 'completemodulenode',
  templateUrl: './completemodulenode.component.html',
  styleUrls: ['./completemodulenode.component.css']
})
export class CompleteNodeComponent implements OnInit {
  ...
  //         values.push(parent[i].getAttribute("data"));
  //       }
  //     }
  //     values = values.reverse();
  //     console.log(values);
  //     this.service.setindex(values);
  ...
  var checked1= !checked;
    ...
    this.service.setcompleteindex(result);
