...
import { JdlgSearchResult } from '../../datamodel/jdlgsearchcomp/jdlgsearchresult';
declare var $: any;
@Component({
  selector: 'jdlgsearch',//defined in app.component.html
  templateUrl: './jdlgsearch.component.html',
  styleUrls: ['./jdlgsearch.component.css']
})
export class JdlgSearchComponent implements OnInit {
  @Input() id: any;
  @Output() onselect: EventEmitter<JdlgSearchResult> = new EventEmitter<JdlgSearchResult>();
  @Output() afterselect: EventEmitter<any> = new EventEmitter<any>();
  jdlgsearchresult: JdlgSearchResult;
...
searching(){
  $('#search').addClass('addcolor');
}
advsearch(){
  $('#advsearch').addClass('addcolor');
}
setfavorite(){
  // $('#favorite').addClass('addcolor');
}
getmodaldata(searchid, targetid) {  
  ...
  $('#jdlgsearch').modal('show');
  // $('#progress').addClass('is-visible');
 
//   this.service.getJdlgsearch(searchid)
//     .subscribe
//     (response => {
...
//     }
//   }    
//   this.jdlgsearchresult = new JdlgSearchResult();
//   this.jdlgsearchresult.id = this.targetid;
//   console.log(this.selectid);
//   this.jdlgsearchresult.data = this.dialogdata[this.indexvalue];
//   this.jdlgsearchresult.columncount = this.array.length;
//   this.jdlgsearchresult.searchid = this.searchid;
//   console.log(this.jdlgsearchresult);
//   this.onselect.emit(this.jdlgsearchresult);
// }
